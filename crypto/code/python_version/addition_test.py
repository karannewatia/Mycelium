...
[b, a, s] = lwe.key_gen()
#encrypt the plaintext using the public key to create a ciphertext (v,u)
[v, u] = lwe.enc(b, a, x)
[v1, u1] = lwe.enc(b, a, x)

add_start = time.time()
v2, u2 = v1, u1
#add the ciphertext to itself 100 times
...
x2 = lwe.dec(v2, u2, s) #decrypt the ciphertext using the secret key
