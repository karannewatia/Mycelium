...
n = 1.3e09 #number of users
k_vals = [2,3,4] #number of hops in the communication path
f_vals = [0.005, 0.01, 0.015, 0.02] #fractions of malicious users who collude with the aggregator
...
# plt.plot(k_vals, plot_7, label = "f=0.015, r=3", color='tab:green')
# plt.plot(k_vals, plot_8, label = "f=0.02, r=3", color='tab:red')
