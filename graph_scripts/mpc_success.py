...
#     result = graph_a(i/100, 20, 1)
#     graph_a_4.append(result)
#
...
# plt.plot(byzantine_rates, graph_a_4, marker="X")
...
# plt.legend(["committee size 5", "committee size 10", "committee size 15", "committee size 20"])
# plt.xticks(byzantine_rates)
# plt.savefig('../graphs/committee/mpc_failure_rate.eps', format='eps')
...
plt.savefig('../graphs/committee/query_success_rate.eps', format='eps')
